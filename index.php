<?php
    ...
    function getTeamUser($id)
    {
        ...
        $sql = "SELECT teams.name as name FROM team_users LEFT JOIN teams ON teams.id = team_users.team_id WHERE team_users.user_id = $id";

        $result = $mysqli->query($sql);

        // Fetch all
        $teamusers = $result->fetch_all(MYSQLI_ASSOC);
