<?php
    ...
    $sql = "SELECT users.firstname as firstname, users.lastname as lastname, teams.name as team FROM team_users LEFT JOIN users ON users.id = team_users.user_id LEFT JOIN teams ON teams.id = team_users.team_id";

    $result = $mysqli->query($sql);

    // Fetch all
    $teams_users = $result->fetch_all(MYSQLI_ASSOC);
